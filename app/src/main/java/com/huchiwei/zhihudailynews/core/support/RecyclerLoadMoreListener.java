...
public abstract class RecyclerLoadMoreListener extends RecyclerView.OnScrollListener{
    ...
    public RecyclerLoadMoreListener(LinearLayoutManager layoutManager) {
        init();
        this.mLayoutManager = layoutManager;
    }

    public RecyclerLoadMoreListener(GridLayoutManager layoutManager) {
        init();
        this.mLayoutManager = layoutManager;
        visibleThreshold = visibleThreshold * layoutManager.getSpanCount();
    }

    public RecyclerLoadMoreListener(StaggeredGridLayoutManager layoutManager) {
        init();
        this.mLayoutManager = layoutManager;
        visibleThreshold = visibleThreshold * layoutManager.getSpanCount();
    }
